...
import com.example.fullvideoview.databinding.ActivityDivisionTutorBinding;
import com.example.fullvideoview.databinding.ActivityMultiplicationTutorBinding;

import java.io.IOException;

public class divisionTutorActivity extends AppCompatActivity {

    ActivityDivisionTutorBinding binding;

    private MediaPlayer mediaPlayer;
    int vidResourceId = R.raw.division; //video
    Button btnskip,btnReload;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityDivisionTutorBinding.inflate(getLayoutInflater());
...
//                mediaPlayer.stop();
//                mediaPlayer.release();
                moveToDivisionActivity();
            }
        });
    }
    private void moveToDivisionActivity() {
