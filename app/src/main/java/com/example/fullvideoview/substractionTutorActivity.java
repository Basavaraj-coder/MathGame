...
import com.example.fullvideoview.databinding.ActivitySubstractionTutorBinding;

import java.io.IOException;

public class substractionTutorActivity extends AppCompatActivity {
    ActivitySubstractionTutorBinding binding;
    private MediaPlayer mediaPlayer;
    int vidResourceId = R.raw.substractionvid;
    Button btnskip,btnReload;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySubstractionTutorBinding.inflate(getLayoutInflater());
    ...
    private void loadSkipButton() {
        ...
        btnskip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mediaPlayer.stop();
                mediaPlayer.release();
                moveToSubstractActivity();
            }
        });
    }

    private void moveToSubstractActivity() {
        Intent i = new Intent(this, substractActivity.class);
